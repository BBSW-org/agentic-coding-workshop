...
BACKGROUND_URL="https://images.unsplash.com/photo-1773751392385-8aa0495f2fbb?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb&dl=andrei-castanha-cCWKt_dHMvQ-unsplash.jpg&w=2400"
...
magick "$PROCESSED_BACKGROUND" \
	assets/cover-title.png -geometry -50-450 \
	-gravity center -composite \
	assets/cover-author.png -geometry -370-950 \
	-gravity center -composite \
	-resize 50% \
